  ...
  return (
    <>
      <footer className="bg-gray-800 text-white py-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} FORMULAR 1 CHEMICAL SOLUTION. All
            rights reserved.
          </p>
        </div>
      </footer>
      ...
      <a
        ...
        className="fixed animate-bounce hover:animate-none bottom-6 left-6 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 z-50"
      >
